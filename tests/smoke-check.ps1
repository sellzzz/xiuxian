...
foreach ($marker in @('relationshipEvents:', 'influenceRules:', 'artifacts:', 'moonLamp:', 'breakthroughBonus:', 'meditationScale:')) {
...
foreach ($marker in @('grantArtifact', 'artifactBonus', 'configuredArtifactMarkup', 'migrateSave')) {
