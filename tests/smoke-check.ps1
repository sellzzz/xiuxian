...
foreach ($marker in @('grantArtifact', 'setArtifactReward', 'artifactBonus', 'artifactEffectSummary', 'artifactRewards', 'artifactRewardText', 'configuredArtifactMarkup', 'migrateSave', 'inspectArtifact', 'removeInspectedArtifact', 'useInspectedArtifact', 'tickArtifactCooldowns', 'useArtifact(id)', 'artifactCooldowns?.[id]', 'LEGACY_MUSIC_VOLUME_KEY', 'music-volume-v2')) {
